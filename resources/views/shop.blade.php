                        ...
                        <div class="geodir-single-tabs-container">
                            <div class="geodir-tabs" id="gd-tabs">
                                <dl class="geodir-tab-head"><dt></dt>
                                    <dd class="geodir-tab-active"><a data-tab="#post_content" data-status="enable"><i class="fas fa-home" aria-hidden="true"></i>關於</a></dd><dt></dt>
                                    @if($shop->photos->count())
                                        <dd class=""><a data-tab="#post_images" data-status="enable"><i class="fas fa-image" aria-hidden="true"></i>照片</a></dd><dt></dt>
                                    @endif
                                    @if($shop->latitude && $shop->longitude)
                                        <dd class=""><a data-tab="#post_map" data-status="enable"><i class="fas fa-globe-americas" aria-hidden="true"></i>地點</a></dd><dt></dt>
                                    @endif
                                    @if($shop->days->count())
                                        <dd class=""><a data-tab="#working_hours" data-status="enable"><i class="fas fa-clock" aria-hidden="true"></i>營業時間</a></dd>
                                    @endif
                                </dl>
                                            ...
                                            <div class="geodir_post_meta  geodir-field-post_content">
                                                ...
                                                @if($shop->days->count())
                                                    @if($shop->working_hours->currentOpenRange(now()))
                                                        <p>販售據點正在開放中，將於 {{ $shop->working_hours->currentOpenRange(now())->end() }} 結束營業。</p>
                                                    @else
                                                        <p>販售據點已經結束營業從 {{ $shop->working_hours->previousClose(now())->format('l H:i') }}
                                                            ，將於 {{ $shop->working_hours->nextOpen(now())->format('l H:i') }} 開放營業。</p>
                                                    @endif
                                                @endif
                                                <p></p>
                                            </div>
                        ...
                        <div class="geodir-single-taxonomies-container">
                            <div class="geodir-pos_navigation clearfix">
                                <div class="geodir-post_left">
                                    <a href="{{ url()->previous() }}" rel="prev">返回</a>
                                </div>
                            </div>
                        </div>
                    </div>
