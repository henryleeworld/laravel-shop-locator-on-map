        ...
        <div class="col-md-12">
            <div class="content-box content-single">
                <article class="post-8 page type-page status-publish hentry">
                    <header>
                        <h1 class="entry-title">{{ request()->filled('search') || request()->filled('category') ? '搜尋結果' : '全部販售據點' }}</h1></header>
                                    ...
                                    <div class="clearfix geodir-loc-bar-in">
                                        <div class="geodir-search">
                                            ...
                                            <div class='gd-search-input-wrapper gd-search-field-search'> <span class="geodir-search-input-label"><i class="fas fa-search gd-show"></i><i class="fas fa-times geodir-search-input-label-clear gd-hide" title="Clear field"></i></span>
                                                <input class="search_text gd_search_text" name="search" value="{{ old('search', request()->input('search')) }}" type="text" placeholder="搜尋據點" aria-label="搜尋據點" autocomplete="off" />
                                            </div>
                                    ...
                                    <li class="gd_place type-gd_place status-publish has-post-thumbnail">
                                        ...
                                        <div class="gd-list-item-right ">
                                            ...
                                            <div class="geodir-post-content-container">
                                                <div class="geodir_post_meta  geodir-field-post_content" style='max-height:120px;overflow:hidden;'>{{ $shop->description }} <a href='{{ route('shop', $shop->id) }}' class='gd-read-more  gd-read-more-fade'>繼續閱讀...</a></div>
                                            </div>
                                        </div>
                                    </li>
                                @endforeach
                ...
                <div class="geodir-bubble-meta-side">
                    ...
                    <div class="geodir-output-location geodir-output-location-mapbubble">
                        <div class="geodir_post_meta  geodir-field-post_title"><span class="geodir_post_meta_icon geodir-i-text">
                            ...
                            <span class="geodir_post_meta_title">名稱：</span></span>`+place.name+`</div>
                        <div class="geodir_post_meta  geodir-field-address" itemscope="" itemtype="http://schema.org/PostalAddress">
                            ...
                            <span class="geodir_post_meta_title">地址：</span></span><span itemprop="streetAddress">`+place.address+`</span>
                        </div>
                    </div>
                    </div>
                </div>
