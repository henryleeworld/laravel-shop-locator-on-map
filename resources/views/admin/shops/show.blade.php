...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-light" href="{{ route('admin.shops.index') }}">
                        ...
                        <td>
                            @if($shop->days)
                                @foreach($shop->days as $day)
                                    ...
                                    開始 <strong>{{ $day->pivot->from_hours }}:{{ $day->pivot->from_minutes }}</strong>
                                    結束 <strong>{{ $day->pivot->to_hours }}:{{ $day->pivot->to_minutes }}</strong>
                                    <br>
                                @endforeach
                            @endif
                        </td>
